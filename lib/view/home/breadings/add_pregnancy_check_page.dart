...
class AddPregnancyCheck extends StatefulWidget {
  const AddPregnancyCheck({super.key});
  @override
  State<AddPregnancyCheck> createState() => _AddPregnancyCheckState();
}

class _AddPregnancyCheckState extends State<AddPregnancyCheck> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: PreferredSize(
        child: SafeArea(child: CustomAppBar2(title: "Add Pregnancy Check")),
              ...
              children: [
                ...
                service.state?Container(
                  ...
                  child: GestureDetector(
                    onTap: () {
                      Map extraData = {
                        "subType": "Pregnancy Check",
                        "subValue": "",
                        "urlSound": service.ultraSound.text,
                        "mediation": service.mediationNote.text,
                      };
