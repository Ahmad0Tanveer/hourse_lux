...
class NewEventTaskPage extends StatefulWidget {
  const NewEventTaskPage({super.key});
  @override
  State<NewEventTaskPage> createState() => _NewEventTaskPageState();
}

class _NewEventTaskPageState extends State<NewEventTaskPage> {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: ListView(
        children: [
          ScheduleTypeSelect(selectValue: "Task",), SizedBox(height: 10),
          MyInputShadow(
              title: "Service",
              widget: InkWell(
              ...
              widget: Container(
                ...
                child: Row(
                  children: [
                    ...
                    SizedBox(width: 10),
                    Text("#9747FF",style :Get.textTheme.bodyMedium!.copyWith(
                      fontSize: 16,
