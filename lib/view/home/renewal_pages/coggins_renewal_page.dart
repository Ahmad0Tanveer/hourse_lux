...
class CogginsRenewalPage extends StatefulWidget {
  const CogginsRenewalPage({super.key});

  @override
  State<CogginsRenewalPage> createState() => _CogginsRenewalPageState();
}

class _CogginsRenewalPageState extends State<CogginsRenewalPage> {
                ...
                service.state
                    ...
                    : Container(
                        ...
                        child: GestureDetector(
                          onTap: () => service.saveServiceData(type: "Coggins", recordType: ServiceTypeHelper.renewals),
                          child: Container(
                            height: 55,
