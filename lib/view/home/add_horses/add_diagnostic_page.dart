  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: PreferredSize(
        child:  SafeArea(child: CustomAppBar2(title: "Add Diagnostics")),
              ...
              children: [
                ...
                service.state?Container(
                  ...
                  child: GestureDetector(
                    onTap: () => service.saveServiceData(type: selectedType, recordType: ServiceTypeHelper.diagnostics),
                    child: Container(
                      height: 55,
        ...
        builder: (context) {
          return Container(
            ...
            child: SelectBottomSheet(
              onTap: changeType,
              title: "Select Diagnostic Records",
              options: AddHorseData.diagnostic,
