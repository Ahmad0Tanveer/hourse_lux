  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: PreferredSize(
        child: SafeArea(child: CustomAppBar2(title: "Add Therapy")),
              ...
              children: [
                ...
                service.state?Container(
                  ...
                  child: GestureDetector(
                    onTap: () => service.saveServiceData(type: selectedType, recordType: ServiceTypeHelper.therapy),
                    child: Container(
                      height: 55,
        ...
        builder: (context) {
          return Container(
            ...
            child: SelectBottomSheet(
              ...
              options: AddHorseData.therapyTypes,
