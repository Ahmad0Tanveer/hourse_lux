...
class AddJointInjectionPage extends StatefulWidget {
  const AddJointInjectionPage({super.key});
  @override
  State<AddJointInjectionPage> createState() => _AddJointInjectionPageState();
}

class _AddJointInjectionPageState extends State<AddJointInjectionPage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: PreferredSize(
        child: SafeArea(child: CustomAppBar2(title: "Add Joint Injection")),
            ...
            children: [
              ...
              service.state?Container(
                ...
                child: GestureDetector(
                  onTap: () => service.saveServiceData(type: selectedType, recordType: ServiceTypeHelper.jointInjection),
                  child: Container(
                    height: 55,
        ...
        builder: (context) {
          return Container(
            ...
            child: SelectBottomSheet(
              onTap: changeType,
              title: "Select Joint Record",
              options: AddHorseData.jointsType,
