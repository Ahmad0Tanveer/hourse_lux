...
import 'package:hourse_lux/view/home/add_contacts/owner_groups.dart';
                        ...
                        GestureDetector(
                          ...
                          child: Container(
                            ...
                            child: Text(
                              ...
                              style: TextStyle(
                                color:
                                    contactActive ? Colors.white : Colors.black,
                              ),
                            ),
                          ),
                        ),
                      ...
                      ? !contact.state
                          ? ListView.builder(
                              ...
                              itemBuilder: (context, index) {
                                ...
                                if (index == 0) {
                                  firstChar = contact
                                      .contacts[index].fullName[0]
                                      .toUpperCase();
                                } else if (firstChar !=
                                    contact.contacts[index].fullName[0]
                                        .toUpperCase()) {
                                  firstChar = contact
                                      .contacts[index].fullName[0]
                                      .toUpperCase();
                                          ...
                                          child: Row(
                                            children: [
                                              Padding(
                                                ...
                                                child: CustomText(
                                                  text:
                                                      "${contact.contacts[index].fullName} ${contact.contacts[index].lastName}",
                                                  color: blackColor,
                                                  fontSize: 15.sp,
                          ...
                          : Container(child: LoadingListShimmerEffect())
                      : OwnerGroupsWidget(),
                ],
              ),
            );
