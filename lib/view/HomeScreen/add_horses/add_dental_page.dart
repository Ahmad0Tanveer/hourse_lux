  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: PreferredSize(
        child:  SafeArea(child: CustomAppBar2(title: "Add Dental")),
                    ...
                    widget: InkWell(
                      ...
                      child: Container(
                        ...
                        child: Row(
                          ...
                          children: [
                            Text(service.adminContact!=null? "${service.adminContact!.firstName} ${service.adminContact!.lastName}":"Select Dentist", style: Get.textTheme.bodyMedium),
               ...
               service.file != null? Container(
                ...
                service.state?Container(
                  ...
                  child: GestureDetector(
                    child: InkWell(
                      onTap: () => service.saveServiceData(type: "", recordType: ServiceTypeHelper.dental),
                      child: Container(
                        height: 55,
